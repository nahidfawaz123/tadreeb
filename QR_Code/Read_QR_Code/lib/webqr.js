...
function read(a)
{
    ...
    for(i in arr){
        ...
        document.getElementById("triness_id").value= arr[0];    
        document.getElementById("workshop_id").value= arr[1];    
        document.getElementById("username").value= arr[2]; 
        //document.getElementById("fullname").innerHTML= "<b><u>full name:</u> " + arr[3] + "</b>";     
    }
    var audio = new Audio('lib/beep.ogg');
    audio.play();

    check_card_data(arr[0] , arr[1] , arr[2] );
}	
...
function setwebcam()
{
    document.getElementById("triness_id").innerHTML="";
    document.getElementById("workshop_id").innerHTML="";
